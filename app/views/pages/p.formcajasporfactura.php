    ...
    <?php endforeach; ?>
        <div class="form-group">
          <div class="col-sm-offset-1 col-sm-10"> 
              ...
              <?php echo ($validacion[0][0] == 0) ? "" : "disabled";?>> Nueva caja <i class="fa fa-plus"></i></button>
         </div> 
        </div>
    </form>
  </div>
...
<br><br>
<!-- Finaliza formulario para creación de nueva caja. -->

<!-- Formulario cajas de la factura -->
