                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables">
                        ...
                        <tbody>
                            <tr>
                                ...
                                foreach ($saldoVencido as $data){
                                    ...
                                    if($data->CC == 'CCA' and $data->DIAS_PAGO == 'L'){
                                        ...
                                        $saldovmu = empty($data->TOTAL)? '0.00':$data->TOTAL; 
                                        ...
                                        $saldovbmu = empty($data->TOTAL)? '0.00':$data->TOTAL; 
                                        ...
                                        $saldovcmu = empty($data->TOTAL)? '0.00':$data->TOTAL; 
                            ...
                            <tr>
                                ...
                                <?php if ($cartera == 'CCA'|| $cartera == '99'):
                                    ?>
                                <td align="center" ><?php echo '$ '.number_format($saldomu,2);?> <br/>
                                     $ <?php echo (empty($saldovmu))? '0.00':number_format($saldovmu,2) ?></td>
                                <?php endif ?>
                                <?php if ($cartera == 'CCB' || $cartera == '99'):?>
                                <td align="center"><?php echo '$ '.number_format($saldobmu,2,".",",");?> <br> 
                                    $ <?php echo (empty($saldovbmu))? '0.00':number_format($saldovbmu,2) ?></td>
                                <?php endif;?>
                                <?php if($cartera == 'CCC' || $cartera == '99'):?>
                                <td align="center"><?php echo '$ '.number_format($saldocmu,2)?>  <br> 
                                    $ <?php echo (empty($saldovcmu))? '0.00':number_format($saldovcmu,2) ?></td>
                                <?php endif;?>
                                <?php if($cartera == 'CCD' || $cartera  == '99'):?>
                                <td align="center"><?php echo '$ '.number_format($saldodmu,2)?> <br/>
                                        $ <?php echo (empty($saldovdmu))? '0.00':number_format($saldovdmu,2) ?>
                                </td>
                                <?php endif;?>
                                <?php if($cartera == '99'):?>
                                <td>
                                $ <?php $sumSaldoMu=($saldomu + $saldobmu + $saldocmu +$saldodmu);  echo number_format($sumSaldoMu,2); ?>
                                <br/>
                                    $ <?php echo number_format(($saldovmu + $saldovbmu + $saldovcmu + $saldovdmu),2)?></td>
                                <?php endif; ?>
                            </tr>
                            <tr style="background-color: yellow">
                                <td>Total: </td>
                                <?php if($cartera == 'CCA' || $cartera  == '99'):?>
                                <td align="center" ><?php echo '$ '.number_format(($saldol + $saldoma + $saldomi + $saldoj + $saldov + $saldomu),2);?> <br/>
                                    $ <?php echo number_format(($saldovl + $saldovma + $saldovmi + $saldovj + $saldovv + $saldovmu),2)?>
                                </td>
                                <?php endif;?>
                                <?php if($cartera == 'CCB' || $cartera  == '99'):?>
                                <td align="center"><?php echo '$ '.number_format(($saldobl + $saldobma + $saldobmi + $saldobj + $saldobv + $saldobmu),2,".",",");?> <br/>
                                    $ <?php echo number_format(($saldovbl + $saldovbma + $saldovbmi + $saldovbj + $saldovbv + $saldovbmu),2)?> </td>
                                <?php endif;?>
                                <?php if($cartera == 'CCC' || $cartera  == '99'):?>
                                <td align="center"><?php echo '$ '.number_format(($saldocl + $saldocma + $saldocmi + $saldocj + $saldocv + $saldocmu),2)?> <br/>
                                    $ <?php echo number_format(($saldovcl + $saldovcma + $saldovcmi + $saldovcj + $saldovcv + $saldovcmu),2)?></td>
                                <?php endif;?>
                                <?php if($cartera == 'CCD' || $cartera  == '99'):?>
                                <td align="center" ><?php echo '$ '.number_format(($saldodl + $saldodma + $saldodmi + $saldodj + $saldodv + $saldodmu),2)?> <br/>
                                    $ <?php echo number_format(($saldovdl + $saldovdma + $saldovdmi + $saldovdj + $saldovdv + $saldovdmu),2)?> </td>
                                <?php endif;?>
                                <?php if($cartera  == '99'):?>
                                <td>
                                    $ <?php echo number_format(($sumSaldoL + $sumSaldoMa + $sumSaldoMi + $sumSaldoJ + $sumSaldoV + $sumSaldoMu),2)?>
                                <br/>
                                    $ <?php echo number_format(($saldovl + $saldovma + $saldovmi + $saldovj + $saldovv + $saldovmu)+($saldovcl + $saldovcma + $saldovcmi + $saldovcj + $saldovcv + $saldovcmu)+($saldovcl + $saldovcma + $saldovcmi + $saldovcj + $saldovcv + $saldovcmu)+ ($saldovdl + $saldovdma + $saldovdmi + $saldovdj + $saldovdv + $saldovdmu),2)?>
                                </td>
                                <?php endif;?>
                            </tr>
                        </tbody>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        ?>
                            ...
                            <form action="index.php" method="POST">
                                ...
                                <td><?php echo '$ '.number_format($data->S15,2);?></td>
