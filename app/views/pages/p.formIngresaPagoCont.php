                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables">
                                  ...
                                  <tbody>
                                       <tr>
                                        ...
                                        <td>
                                            <input name="monto" type="number" step = "any" required="required" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <button name="ingresarPago" type="submit" value="enviar" class ="">Agregar</button> 
                                        </td>
...
<label style="font-size: 20px"> SALDO GENERAL DE LA CUENTA: $ <?php echo $data->SALDO ?></label>
