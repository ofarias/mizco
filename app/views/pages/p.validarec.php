                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-usuarios">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX" <?php echo $color;?>>
                                            ...
                                            <td><button name="ValParOk" type="submit" value="enviar" class="btn btn-warning"><i class="fa fa-check"></i></button>
                                            </td> 
                                            </form>      
                                        </tr>
                                        <?php endforeach; ?>
...
<script type="text/javascript">
    ...
    function enviar(iterador){
        ...
        var campo = document.getElementById("cantn_"+iterador).value;
