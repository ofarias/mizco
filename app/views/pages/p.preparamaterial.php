                                  ...
                                  <tbody>
                                        ...
                                        <tr class="odd gradeX" <?php echo $color;?>>
                                         <!--<tr class="odd gradeX" style='background-color:yellow;' >-->
                                            ...
                                            <td>
                                            <input name="cantn" type="text" size="4" value="<?php echo $cantemp?>" id="cantn_<?php echo $i;?>" required = "required" onchange="validafaltante(this.value, <?php echo $i;?>)" />
                                            </td>
                                            <td>
                                             <input name="empaque" type ="number" min="1" size = "4" required="required"/>
                                            </td>
                                            <td>
                                                <select class="form-control" name="tipopaq">
                                            ...
                                            <td>
                                                <button name="AsignaEmpaque" type="submit" value="enviar" class="btn btn-warning"><i class="fa fa-check">Preparar </i></button>
                                            </td> 
                                            </form>      
                                        </tr>
