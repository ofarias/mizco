                ...
                <?php foreach($exec as $dat): ?>
                    ...
                    <div class="form-group">
                        <label for="lineacred" class="col-lg-2 control-label">Linea de credito: </label>
                            <div class="col-lg-8">
                                <input type="number" step="any" class="form-control" name="lincred" id="lincred" value="<?php echo $dat->LINEA_CRED;?>" required = "required" min="0"/><br>
                            </div>
                    </div>
                ...
                <div class="panel-footer">
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <button name="salvaCambiosDatoCobranza" type="submit" class="btn btn-warning" form="form1">Guardar <i class="fa fa-floppy-o"></i></button>
